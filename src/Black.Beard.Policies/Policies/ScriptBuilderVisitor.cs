...
namespace Bb.Policies
{
    ...
    public class ScriptBuilderVisitor : PolicyParserBaseVisitor<object?>
    {
        ...
        public override object? VisitScript([NotNull] PolicyParser.ScriptContext context)
        {
            ...
            foreach (var item in pair)
            {
                ...
                var o = item.Accept(this) as PolicyNamed;
                if (o != null)
                {
        ...
        public override object? VisitPair_include([NotNull] PolicyParser.Pair_includeContext context)
        {
            ...
            if (str != null)
            {
                var s = str.Accept(this) as string;
        ...
        public override object? VisitPair_alias([NotNull] PolicyParser.Pair_aliasContext context)
        {
            ...
            var _id = context.alias_id().Accept(this) as string;
        ...
        public override object? VisitPair_policy([NotNull] PolicyParser.Pair_policyContext context)
        {
            ...
            if (expr != null)
            {
                ...
                using (var ctx = NewContext())
                {
                    ...
                    var _id = policy_id.Accept(this) as string;
                    if (string.IsNullOrEmpty(_id))
                        throw new NotImplementedException(context.GetText());

                    var e = expr.Accept(this) as Policy;
                    if (e == null)
                        throw new NotImplementedException(context.GetText());
                    ...
                    if (categories != null)
                    {
                        var c = categories.Accept(this) as List<string>;
                        if (c != null)
        ...
        public override object? VisitExpression([NotNull] PolicyParser.ExpressionContext context)
        {
            ...
            using (var ctx = NewContext())
            {
                ...
                if (key_ref != null)
                {
                    ...
                    left = key_ref.Accept(this) as Policy;
                    if (left == null)
                        throw new NotImplementedException(context.GetText());
                    ...
                    if (value_ref != null)
                    {
                        ...
                        _operator = @operator.Accept(this).CheckAndConvertTo<PolicyOperator>();
                        right = value_ref.Accept(this) as Policy;
                        if (right == null)
                            throw new NotImplementedException(context.GetText());
                    ...
                    if (oo != null)
                    {
                        _operator = context.operationBoolean().Accept(this).CheckAndConvertTo<PolicyOperator>();
                        return new PolicyOperationUnary(left, _operator) { Location = context.ToLocation() };
                    }
                ...
                left = e[0].Accept(this) as Policy;
                if (left == null)
                    throw new NotImplementedException(context.GetText());
                ...
                if (operaC != null)
                {
                    _operator = operaC.Accept(this).CheckAndConvertTo<PolicyOperator>();
                    right = context.array().Accept(this) as Policy;
                    if (right == null)
                        throw new NotImplementedException(context.GetText());
                    return new PolicyOperationBinary(left, _operator, right) { Location = context.ToLocation() };
                }
                ...
                if (o2 != null)
                {
                    _operator = o2.Accept(this).CheckAndConvertTo<PolicyOperator>();
                    right = e[1].Accept(this) as Policy;
                    if (right == null)
                        throw new NotImplementedException(context.GetText());
                    return new PolicyOperationBinary(left, _operator, right) { Location = context.ToLocation() };
                }
        ...
        public override object? VisitArray([NotNull] PolicyParser.ArrayContext context)
        {
            ...
            {
                var o = item.Accept(this) as PolicyConstant;
                if (o == null)
                    throw new NotImplementedException(context.GetText());
                items.Add(o);
            }
        ...
        public override object? VisitCategories([NotNull] PolicyParser.CategoriesContext context)
        {
            ...
            foreach (var item in values)
            {
                var o = item.Accept(this) as string;
        ...
        public void EvaluateErrors(IParseTree item)
        {
            ...
            if (item != null)
            {
                ...
                else if (item is ParserRuleContext r && r.exception != null)
                    AddError(r);
        ...
        /// </code>
        /// </example>
        protected void AddError(TextLocation? start, string txt, string message, string? path = null)
        {
        ...
        /// </code>
        /// </example>
        protected void AddError(ParserRuleContext r)
        {
        ...
        /// </code>
        /// </example>
        protected void AddError(ErrorNodeImpl e)
        {
        ...
        /// </code>
        /// </example>
        protected void AddWarning(TextLocation start, string txt, string message, string? path = null)
        {
        ...
        /// <summary>
        /// Gets the initial source of the script being processed.
        /// </summary>
        public StringBuilder? InitialSource => _initialSource;
    ...
    internal static class Extensions
    {
        ...
        public static T CheckAndConvertTo<T>(this object? data)
        {
            ...
            throw new InvalidOperationException($"Datas {data?.ToString()} can't be converted to {typeof(T)}");
